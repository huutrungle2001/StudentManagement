...
public class AboutUsDialog extends javax.swing.JDialog {
    ...
    public AboutUsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);//cửa sổ xuất hiện ở giữa hộp cha
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/studentmangager/icons/10207-man-student-light-skin-tone-icon-64.png"))); // NOI18N
        ...
        jLabel4.setText("Hà Đức Hải");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("Vũ Đức Duy");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("Lê Hữu Trung");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("Cao Đức Vũ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();// đóng hộp thoại mà không đóng chương trình
